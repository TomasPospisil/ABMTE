...
public class DetailActivity extends AppCompatActivity {
    ...
    private void FillData(int id) {
        ...
        ((TextView) findViewById(R.id.label_book_name)).setText(nodes[0]);
        ((TextView) findViewById(R.id.authorName)).setText(nodes[1]);
        ((ImageView) findViewById(R.id.imageView)).setImageResource(R.mipmap.image_book_unknown_foreground);
    }

    private void SetListeners() {
        final Button cancel = findViewById(R.id.button_detail_cancel);
        ...
        final Button save = findViewById(R.id.button_detail_ok);
    ...
    private void SaveNewBook() {
        String bookName = ((TextView) findViewById(R.id.label_book_name)).getText().toString();
        String authorName = ((TextView) findViewById(R.id.authorName)).getText().toString();
